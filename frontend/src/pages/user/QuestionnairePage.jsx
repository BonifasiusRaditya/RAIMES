                  ...
                  <div key={`question-${questionId}`} className="border-2 border-gray-200 rounded-lg p-6 hover:border-raimes-purple transition-all">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {/* Multiple Choice Question with Database Options */}
                        {question.type === "multiple_choice" && (
                          <div className="space-y-3">
                            {["option_a", "option_b", "option_c", "option_d", "option_e"].map((optionKey, idx) => {
                              const optionValue = questionOptions[optionKey];
                              if (!optionValue) return null; // Skip if option doesn't exist
