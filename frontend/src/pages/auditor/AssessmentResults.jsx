...
export default function AssessmentResults() {
  ...
  // Function untuk handle View Detail - redirect ke AI Analysis page
  const handleViewDetail = (assessmentId) => {
    navigate(`/ai-analysis/${assessmentId}`);
  };
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="px-3 py-2 border-2 border-raimes-purple text-raimes-purple font-semibold rounded-lg hover:bg-raimes-purple hover:text-white transition-colors"
                      ...
                      <button className="px-3 py-2 bg-raimes-yellow text-white font-semibold rounded-lg hover:opacity-90 transition-opacity">
                        <svg className="w-5 h-5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
